...
if dump_molden:
    real_mo_coeff = np.loadtxt(working_dir + '/real_MOs_alpha.dat')
    imag_mo_coeff = np.loadtxt(working_dir + '/imag_MOs_alpha.dat')
    molden.from_mo(mol, working_dir + "/real_MOs_alpha.molden", real_mo_coeff)
    molden.from_mo(mol, working_dir + "/imag_MOs_alpha.molden", imag_mo_coeff)
    real_mo_coeff = np.loadtxt(working_dir + '/real_MOs_beta.dat')
    imag_mo_coeff = np.loadtxt(working_dir + '/imag_MOs_beta.dat')
    molden.from_mo(mol, working_dir + "/real_MOs_beta.molden", real_mo_coeff)
    molden.from_mo(mol, working_dir + "/imag_MOs_beta.molden", imag_mo_coeff)
