  ...
  double precision,parameter    :: HaToeV = 27.211386245988d0
  double precision,parameter    :: pmtoau = 0.0188973d0
  double precision,parameter    :: BoToAn = 0.529177210903d0
  double precision,parameter    :: AnToBo = 1.8897261246257702d0
