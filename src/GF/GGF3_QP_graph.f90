subroutine GGF3_QP_graph(doSRG,eta,flow,nBas,nC,nO,nV,nR,eHF,ERI,eGFlin,eOld,eGF,Z)
...
! Local variables
  ...
  double precision,external     :: GGF3_SigC,GGF3_dSigC
...
! Run Newton's algorithm to find the root
  ...
  do p=nC+1,nBas-nR
    ...
    do while (abs(f) > thresh .and. nIt < maxIt)
      ...
      SigC  = GGF3_SigC(p,w,eta,nBas,nC,nO,nV,nR,eOld,ERI)
      dSigC = GGF3_dSigC(p,w,eta,nBas,nC,nO,nV,nR,eOld,ERI)
      f  = w - eHF(p) - SigC
      df = 1d0/(1d0 - dSigC)
