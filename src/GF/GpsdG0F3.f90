subroutine GpsdG0F3(dotest,linearize,eta,doSRG,nBas,nC,nO,nV,nR,nS,ENuc,EGHF,ERI,eHF)
...
! Frequency-dependent third-order contribution
  ...
  if(doSRG) then 
    ...
    call GpsdGF3_self_energy_diag(eta,nBas,nC,nO,nV,nR,eHF,ERI,SigC,Z)
