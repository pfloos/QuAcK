subroutine GpsdGF3_QP_graph(doSRG,eta,flow,nBas,nC,nO,nV,nR,eHF,ERI,eGFlin,eOld,eGF,Z)
...
! Local variables
  ...
  double precision,external     :: GpsdGF3_SigC,GpsdGF3_dSigC
...
! Run Newton's algorithm to find the root
  ...
  do p=nC+1,nBas-nR
    ...
    do while (abs(f) > thresh .and. nIt < maxIt)
      ...
      SigC  = GpsdGF3_SigC(p,w,eta,nBas,nC,nO,nV,nR,eOld,ERI)
      dSigC = GpsdGF3_dSigC(p,w,eta,nBas,nC,nO,nV,nR,eOld,ERI)
      f  = w - eHF(p) - SigC
      df = 1d0/(1d0 - dSigC)
