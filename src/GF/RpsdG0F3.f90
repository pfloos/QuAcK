subroutine RpsdG0F3(dotest,linearize,eta,doSRG,nBas,nOrb,nC,nO,nV,nR,nS,ENuc,ERHF,ERI,eHF)
...
! Frequency-dependent third-order contribution
  ...
  if(doSRG) then 
    ...
    call RpsdGF3_self_energy_diag(eta,nOrb,nC,nO,nV,nR,eHF,ERI,SigC,Z)
