double precision function GpsdGF3_dSigC(p,w,eta,nBas,nC,nO,nV,nR,e,ERI)
...
! Memory allocation
  ...
  allocate(K_2h1p(n2h1p),dK_2h1p(n2h1p))
  allocate(K_2p1h(n2p1h),dK_2p1h(n2p1h))
  ...
  do i=nC+1,nO
     do j=nC+1,nO
        do a=nO+1,nBas-nR
           ...
           dK_2h1p(ija) = - 1d0 / (w + e(a) - e(i) - e(j))**2
  ...
  do i=nC+1,nO
     do a=nO+1,nBas-nR
        do b=nO+1,nBas-nR
           ...
           dK_2p1h(iab) = - 1d0 / (w + e(i) - e(a) - e(b))**2
  ...
  do i=nC+1,nO
     do j=nC+1,nO
        do a=nO+1,nBas-nR
           ...
           GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2h1p(ija) *  dK_2h1p(ija) * U1_2h1p(ija)
           
           GpsdGF3_dSigC = GpsdGF3_dSigC + U2_2h1p(ija) *  dK_2h1p(ija) * U1_2h1p(ija)
           
           GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2h1p(ija) *  dK_2h1p(ija) * U2_2h1p(ija)
           ...
           do k=nC+1,nO
              do l=nC+1,nO
                 do c=nO+1,nBas-nR
                    ...
                    GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2h1p(ija) * dK_2h1p(ija) * C1_2h1p(ija,klc) *  K_2h1p(klc) * U1_2h1p(klc)
                    GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2h1p(ija) *  K_2h1p(ija) * C1_2h1p(ija,klc) * dK_2h1p(klc) * U1_2h1p(klc)
  ...
  do i=nC+1,nO
     do a=nO+1,nBas-nR
        do b=nO+1,nBas-nR
           ...
           GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2p1h(iab) *  dK_2p1h(iab) * U1_2p1h(iab)

           GpsdGF3_dSigC = GpsdGF3_dSigC + U2_2p1h(iab) *  dK_2p1h(iab) * U1_2p1h(iab)

           GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2p1h(iab) *  dK_2p1h(iab) * U2_2p1h(iab)
           ...
           do k=nC+1,nO
              do c=nO+1,nBas-nR
                 do d=nO+1,nBas-nR
                    ...
                    GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2p1h(iab) * dK_2p1h(iab) * C1_2p1h(iab,kcd) *  K_2p1h(kcd) * U1_2p1h(kcd)
                    GpsdGF3_dSigC = GpsdGF3_dSigC + U1_2p1h(iab) *  K_2p1h(iab) * C1_2p1h(iab,kcd) * dK_2p1h(kcd) * U1_2p1h(kcd)
