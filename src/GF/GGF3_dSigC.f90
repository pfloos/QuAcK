double precision function GGF3_dSigC(p,w,eta,nBas,nC,nO,nV,nR,e,ERI)
  ...
  do i=nC+1,nO
    do j=nC+1,nO
      do a=nO+1,nBas-nR
        ...
        eps = w + e(a) - e(i) - e(j)
        GGF3_dSigC = GGF3_dSigC - 0.5d0*(ERI(p,a,i,j) - ERI(p,a,j,i))**2*(eps**2 - eta**2)/(eps**2 + eta**2)**2
  ...
  do i=nC+1,nO
    do a=nO+1,nBas-nR
      do b=nO+1,nBas-nR
        ...
        eps = w + e(i) - e(a) - e(b)
        GGF3_dSigC = GGF3_dSigC - 0.5d0*(ERI(p,i,a,b) - ERI(p,i,b,a))**2*(eps**2 - eta**2)/(eps**2 + eta**2)**2
...
!------------------------------!
  ...
  GGF3_dSigC = GGF3_dSigC + ZCpp(1) + ZCpp(2) + ZCpp(3) + ZCpp(4) + ZCpp(5) + ZCpp(6)
  
  GGF3_dSigC = GGF3_dSigC + ZDpp(1) + ZDpp(2) + ZDpp(3) + ZDpp(4) + ZDpp(5) + ZDpp(6)
