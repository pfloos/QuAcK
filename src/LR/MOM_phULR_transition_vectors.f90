subroutine MOM_phULR_transition_vectors(ispin,nBas,nC,nO,nV,nR,nS,nSa,nSb,nSt,&
...
! Compute oscillator strengths
  ...
  os(:) = 0d0
  if(ispin == 1) call MOM_phULR_oscillator_strength(nBas,nC,nO,nV,nR,nS,nSa,nSb,nSt,nCVS,nFC,maxS, & 
                                                occupations,virtuals,dipole_int_aa,dipole_int_bb,Om,XpY,XmY,os)

! Compute <S**2>

  call MOM_S2_expval(ispin,nBas,nC,nO,nV,nR,nS,nSa,nSb,nSt,nCVS,nFC,occupations,virtuals,maxS,c,S,Om,XpY,XmY,S2)
