subroutine complex_phULR_B(ispin,dRPA,nBas,nC,nO,nV,nR,nSa,nSb,nSt,nCVS,nFC,occupations,virtuals,lambda,ERI_aaaa,ERI_aabb,ERI_bbbb,Bph)
...
! Output variables
  ...
  complex*16,intent(out)        :: Bph(nSt,nSt)
