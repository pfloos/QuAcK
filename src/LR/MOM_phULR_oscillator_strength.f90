subroutine MOM_phULR_oscillator_strength(nBas,nC,nO,nV,nR,nS,nSa,nSb,nSt,nCVS,nFC,maxS,occupations,virtuals,dipole_int_aa,dipole_int_bb,Omega,XpY,XmY,os)
