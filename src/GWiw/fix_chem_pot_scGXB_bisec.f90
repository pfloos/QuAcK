subroutine fix_chem_pot_scGXB_bisec(iter_hfb,nBas,nBas_twice,nfreqs,nElectrons,thrs_N,thrs_Ngrad,chem_pot,S,H_ao_hfb,Sigma_c_w_ao,wcoord,wweight, &
...
! Output variables
  ...
  call get_1rdm_scGXB(nBas,nBas_twice,nfreqs,chem_pot,S,H_ao_hfb,Sigma_c_w_ao, &
  ...
  do while( abs(trace_old-nElectrons) > thrs_closer .and. isteps <= 100 )
   ...
   call get_1rdm_scGXB(nBas,nBas_twice,nfreqs,chem_pot,S,H_ao_hfb,Sigma_c_w_ao, &
                       wcoord,wweight,G_ao,G_ao_iw_hfb,DeltaG_ao_iw,R_ao,R_ao_hfb,trace_old) 
   call get_1rdm_scGXB(nBas,nBas_twice,nfreqs,chem_pot-delta_chem_pot,S,H_ao_hfb,Sigma_c_w_ao, &
...
!  write(*,*) "| fiding bisection method bounds ...                  |"
  ...
  do
   call get_1rdm_scGXB(nBas,nBas_twice,nfreqs,chem_pot_up,S,H_ao_hfb,Sigma_c_w_ao, &
                       wcoord,wweight,G_ao,G_ao_iw_hfb,DeltaG_ao_iw,R_ao,R_ao_hfb,trace_up)
   call get_1rdm_scGXB(nBas,nBas_twice,nfreqs,chem_pot_down,S,H_ao_hfb,Sigma_c_w_ao, &
                       wcoord,wweight,G_ao,G_ao_iw_hfb,DeltaG_ao_iw,R_ao,R_ao_hfb,trace_down)
