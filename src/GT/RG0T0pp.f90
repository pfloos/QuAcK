...
!  call ppLR_transition_vectors(.false.,nBas,nC,nO,nV,nR,nOOt,nVVt,dipole_int,Om1t,X1t,Y1t,Om2t,X2t,Y2t)
  ...
  call print_RG0T0pp(nOrb,nC,nO,nV,nR,eHF,ENuc,ERHF,Sig,Z,eGT,EcGM,EcRPA)
...
! Perform BSE calculation
  ...
  if(dophBSE) then
    ...
    !call RGTpp_phBSE_omegazero(exchange_kernel,TDA_T,TDA,dBSE,dTDA,singlet,triplet,eta,nOrb,nC,nO,nV,nR,nS,nOOs,nVVs,nOOt,nVVt, & 
    !                Om1s,X1s,Y1s,Om2s,X2s,Y2s,rho1s,rho2s,Om1t,X1t,Y1t,Om2t,X2t,Y2t,rho1t,rho2t,      &
    !                ERI,dipole_int,eHF,eGT,EcBSE)
    !call RGTpp_phBSE_qs(exchange_kernel,TDA_T,TDA,dBSE,dTDA,singlet,triplet,eta,nOrb,nC,nO,nV,nR,nS,nOOs,nVVs,nOOt,nVVt, & 
    !                Om1s,X1s,Y1s,Om2s,X2s,Y2s,rho1s,rho2s,Om1t,X1t,Y1t,Om2t,X2t,Y2t,rho1t,rho2t,      &
    !                ERI,dipole_int,eHF,eGT,EcBSE)
