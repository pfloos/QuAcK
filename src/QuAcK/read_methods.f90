subroutine read_methods(working_dir,                                                  &
                        doRHF,doUHF,doGHF,doROHF,doRHFB,docRHF,docUHF,doeRHF,doscGHF, &
                        doMP2,doMP3,                                                  & 
...
! Output variables
  ...
  logical,intent(out)           :: doRHF,doUHF,doGHF,doROHF,doRHFB,docRHF,docUHF,doeRHF,doscGHF
  ...
  logical,intent(out)           :: do_SOSEX,do_2SOSEX,do_G3W2,do_psdG3W2
  logical,intent(out)           :: do_ADC_GW,do_ADC_2SOSEX,do_ADC3_G3W2,do_ADC3x_G3W2,do_ADC_G3W2
