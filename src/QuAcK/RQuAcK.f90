...
! Restricted branch of QuAcK
  ...
  logical,intent(in)            :: do_SOSEX,do_2SOSEX,do_G3W2,do_psdG3W2
  logical,intent(in)            :: do_ADC_GW,do_ADC_2SOSEX,do_ADC3_G3W2,do_ADC3x_G3W2,do_ADC_G3W2
...
!--------------!
  ...
  if(doscGF2 .and. .not.docRHF) then
   ...
   call scGF2_AO_itau_iw(nBas,nOrb,nO,maxSCF_GF,max_diis_GF,do_linDM_GF,restart_scGF2,verbose_scGF2,chem_pot_scG,no_fock, &
                         ENuc,Hc,S,PHF,cHF_tmp,eHF,nfreqs,wcoord,wweight,ERI_AO)
   deallocate(cHF_tmp)
...
!                         ENuc,Hc,S,X,PHF,cHF_tmp,eHF,nfreqs,wcoord,wweight,vMAT)
   call scGW_AO_itau_iw(nBas,nOrb,nO,maxSCF_GW,thresh_GW,max_diis_GW,do_linDM_GW,dophRPA,restart_scGW,verbose_scGW, &
                        chem_pot_scG,no_fock,ENuc,Hc,S,X,PHF,cHF_tmp,eHF,nfreqs,wcoord,wweight,vMAT,ERI_AO)
