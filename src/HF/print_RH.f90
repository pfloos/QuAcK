...
subroutine print_RH(nBas, nOrb, nO, eHF, cHF, ENuc, ET, EV, EJ, ERH, dipole)
...
! Input variables
  ...
  double precision,intent(in)        :: ERH
...
! Dump results
  ...
  write(*,'(A50)')           '---------------------------------------'
  write(*,'(A33,1X,F16.10,A3)') ' Two-electron energy = ',EJ ,' au'
  write(*,'(A33,1X,F16.10,A3)') ' Hartree      energy = ',EJ,' au'
  write(*,'(A50)')           '---------------------------------------'
  write(*,'(A33,1X,F16.10,A3)') ' Electronic   energy = ',ERH,' au'
  write(*,'(A33,1X,F16.10,A3)') ' Nuclear   repulsion = ',ENuc,' au'
  write(*,'(A33,1X,F16.10,A3)') ' RH           energy = ',ERH + ENuc,' au'
  write(*,'(A50)')           '---------------------------------------'
...
! Print results
  ...
  if(dump_orb) then 
    write(*,'(A50)') '---------------------------------------'
    write(*,'(A50)') ' RH orbital coefficients '
    write(*,'(A50)') '---------------------------------------'
    call matout(nBas, nOrb, cHF)
    write(*,*)
  end if
  write(*,'(A50)') '---------------------------------------'
  write(*,'(A50)') ' RH orbital energies (au) '
  write(*,'(A50)') '---------------------------------------'
