double precision function MOM_SRG_UGW_Re_dSigC(p,w,s,nBas,nC,nO,nV,nR,nS,nCVS,nFC,occupations,virtuals,e,Om,rho)
...
! Occupied part of the correlation self-energy
  ...
  do i=1,nO-nFC
    do m=1,nS
      ...
      MOM_SRG_UGW_Re_dSigC = MOM_SRG_UGW_Re_dSigC &
