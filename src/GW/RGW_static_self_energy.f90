subroutine RGW_static_self_energy(flow,nBas,nOrb,nC,nO,nV,nR,nS,e,Om,rho,EcGM,SigC,Z)
    ...
    do p=nC+1,nOrb-nR
      do m=1,nS
        do i=nC+1,nO
          ...
          Dpim = 0.5d0*(e(p)+e(q)) - e(i) + Om(m)
          Dqim = 0.5d0*(e(p)+e(q)) - e(i) + Om(m)
          SigC(p,q) = SigC(p,q)                  &
    ...
    do p=nC+1,nOrb-nR
      do m=1,nS
        do a=nO+1,nOrb-nR
           ...
           Dpam = 0.5d0*(e(p)+e(q)) - e(a) - Om(m)
           Dqam = 0.5d0*(e(p)+e(q)) - e(a) - Om(m)
           SigC(p,q) = SigC(p,q)                  & 
