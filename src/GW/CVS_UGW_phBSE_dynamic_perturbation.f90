subroutine CVS_UGW_phBSE_dynamic_perturbation(ispin,dTDA,eta,nBas,nC,nO,nV,nR,nS,nSa,nSb,nSt,nS_sc,     &
                                          nCVS,nFC,occupations,virtuals,eW,eGW,                         &
...
! Print main components of transition vectors
  ...
  do ia=1,min(nSt,maxS)
    ...
    if(dTDA) then 
      ...
      call CVS_UGW_phBSE_dynamic_kernel_A(ispin,eta,nBas,nC,nO,nV,nR,nSa,nSb,nSt,nS_sc, &
                                           nCVS,nFC,occupations,virtuals,1d0,eGW,       & 
