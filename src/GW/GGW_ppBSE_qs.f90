subroutine GGW_ppBSE_qs(TDA_W,TDA,dBSE,dTDA,eta,nOrb,nC,nO,nV,nR,nS,ERI,dipole_int,eW,eGW,EcBSE)
...
end subroutine GGW_ppBSE_qs

subroutine GGW_ppBSE_static_kernel_D_qs(eta,nBas,nC,nO,nV,nR,nS,nOO,lambda,ERI,eGW,Om,rho,KD)
      ...
      do k=nC+1,nO
        do l=k+1,nO
          ...
          do m=1,nS
             ...
             num = (rho(i,k,m)*rho(j,l,m) - rho(j,k,m)*rho(i,l,m))/4d0
...
end subroutine GGW_ppBSE_static_kernel_D_qs
