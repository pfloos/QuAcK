subroutine RGW_ppBSE_omegazero(TDA_W,TDA,dBSE,dTDA,singlet,triplet,eta,nOrb,nC,nO,nV,nR,nS,ERI,dipole_int,eW,eGW,EcBSE)
...
!-------------------
 ...
 if(singlet) then
    ...
    call RGW_ppBSE_static_kernel_D_omegazero(ispin,eta,nOrb,nC,nO,nV,nR,nS,nOO,1d0,ERI,eGW,OmRPA,rho_RPA,KD_sta)
    ! if(.not.TDA) then
...
!-------------------
 ...
 if(triplet) then
    ...
    call RGW_ppBSE_static_kernel_C_omegazero(ispin,eta,nOrb,nC,nO,nV,nR,nS,nVV,1d0,ERI,eGW,OmRPA,rho_RPA,KC_sta)
    call RGW_ppBSE_static_kernel_D_omegazero(ispin,eta,nOrb,nC,nO,nV,nR,nS,nOO,1d0,ERI,eGW,OmRPA,rho_RPA,KD_sta)
    if(.not.TDA) then
...
end subroutine RGW_ppBSE_omegazero

subroutine RGW_ppBSE_static_kernel_C_omegazero(ispin,eta,nOrb,nC,nO,nV,nR,nS,nVV,lambda,ERI,eGW,Om,rho,KC)
...
end subroutine RGW_ppBSE_static_kernel_C_omegazero

subroutine RGW_ppBSE_static_kernel_D_omegazero(ispin,eta,nOrb,nC,nO,nV,nR,nS,nOO,lambda,ERI,eGW,Om,rho,KD)
