double precision function MOM_UGW_Re_dSigC(p,w,eta,nBas,nC,nO,nV,nR,nS,nCVS,nFC,occupations,virtuals,e,Om,rho)
...
! Occupied part of the correlation self-energy
  ...
  do i=1,nO-nFC
    do m=1,nS
      ...
      MOM_UGW_Re_dSigC = MOM_UGW_Re_dSigC - num*(eps**2 - eta**2)/(eps**2 + eta**2)**2
    end do
  end do
