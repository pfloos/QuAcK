subroutine RGW_phBSE_omegazero(dophBSE2,exchange_kernel,TDA_W,TDA,dBSE,dTDA,singlet,triplet,eta, & 
...
end subroutine RGW_phBSE_omegazero

subroutine RGW_phBSE_static_kernel_A_omegazero(eta,nBas,nC,nO,nV,nR,nS,lambda,ERI,eGW,Om,rho,KA)
