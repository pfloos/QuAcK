subroutine G_print_qsparquet_1b(nOrb,nC,nO,nV,nR,eHF,SigC,eQP,Z,n_it_1b,err_1b,ENuc,EGHF,EcGM,Ec_eh,Ec_pp)
...
! Dump results
  ...
  do i=nC+1,nO
    ...
    '|',i,'|',eHF(i)*HaToeV,'|',SigC(i,i)*HaToeV,'|',Z(i),'|',eQP(i)*HaToeV,'|'
  end do
  ...
  do a=nO+1,nOrb-nR
    write(*,'(1X,A1,1X,I3,1X,A1,1X,F15.6,1X,A1,1X,F15.6,1X,A1,1X,F15.6,1X,A1,1X,F15.6,1X,A1,1X)') &
    '|',a,'|',eHF(a)*HaToeV,'|',SigC(a,a)*HaToeV,'|',Z(a),'|',eQP(a)*HaToeV,'|'
  end do
