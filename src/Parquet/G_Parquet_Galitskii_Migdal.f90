...
!----------------------------------!
  ...
  write(*,*) '-----------------------------'
  write(*,'(1X,A1,1X,A6,1X,A1,1X,A16,1X,A1,1X)') '|','#','|','Ec^pp','|'
  write(*,*) '-----------------------------'
  write(*,'(1X,A1,1X,I6,1X,A1,1X,F16.10,1X,A1,1X)') '|',1,'|',Ec_pp(1),'|'
  write(*,'(1X,A1,1X,I6,1X,A1,1X,F16.10,1X,A1,1X)') '|',2,'|',Ec_pp(2),'|'
  write(*,'(1X,A1,1X,I6,1X,A1,1X,F16.10,1X,A1,1X)') '|',3,'|',Ec_pp(3),'|'
  write(*,'(1X,A1,1X,I6,1X,A1,1X,F16.10,1X,A1,1X)') '|',4,'|',Ec_pp(4),'|'
  write(*,'(1X,A1,1X,I6,1X,A1,1X,F16.10,1X,A1,1X)') '|',5,'|',Ec_pp(5),'|'
  write(*,'(1X,A1,1X,I6,1X,A1,1X,F16.10,1X,A1,1X)') '|',6,'|',Ec_pp(6),'|'
  write(*,*) '-----------------------------'
  write(*,'(1X,A1,1X,A6,1X,A1,1X,F16.10,1X,A1,1X)') '|','Total','|',sum(Ec_pp),'|'
  write(*,*) '-----------------------------'
  write(*,*) 
