subroutine R_Parquet_self_energy_SRG_dp(eta,nOrb,nC,nO,nV,nR,nS,nOOs,nVVs,nOOt,nVVt,eQP,ERI, &
      ...
      do p=nC+1,nOrb-nR
        ...
        do i=nC+1,nO
          do a=nO+1,nOrb-nR
            ...
            num  = -1d0*(0.5d0*ERI(p,i,a,b) - ERI(p,i,b,a)) * eh_sing_rho(i,a,n)
      ...
      do p=nC+1,nOrb-nR
        ...
        do i=nC+1,nO
          do a=nO+1,nOrb-nR
            ...
            num  = -1d0*1.5d0*ERI(p,i,a,b) * eh_trip_rho(i,a,n)
            dem1 = eQP(p) + eQP(i) - eQP(a) - eQP(b)
            reg1 = 1d0 - exp(- 2d0 * eta * dem1 * dem1)
