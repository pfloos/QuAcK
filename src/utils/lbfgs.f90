...
!C     **********
      ...
      DOUBLE PRECISION DG,DGM,DGINIT,DGTEST,DGX,DGXM,DGY,DGYM,FINIT,FTEST1,FM,FX,FXM,FY,FYM,P5,P66,STX,STY
      DOUBLE PRECISION STMIN,STMAX,WIDTH,WIDTH1,XTRAPF,ZERO
...
!C
      IF (N .LE. 0 .OR. STP .LE. ZERO .OR. FTOL .LT. ZERO .OR. GTOL .LT. ZERO .OR. &
         XTOL .LT. ZERO .OR. STPMIN .LT. ZERO .OR. STPMAX .LT. STPMIN .OR. MAXFEV .LE. 0) RETURN
!C
...
!C
         IF ((BRACKT .AND. (STP .LE. STMIN .OR. STP .GE. STMAX)) .OR. NFEV .GE. MAXFEV-1 .OR. INFOC .EQ. 0 &
