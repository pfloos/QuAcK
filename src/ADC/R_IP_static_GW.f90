subroutine R_IP_static_GW(dotest,sig_inf,TDA_W,flow,nBas,nOrb,nC,nO,nV,nR,nS,ENuc,ERHF,ERI,eHF)

! Pure static version of GW in the 1h space
...
! Hello world
  ...
  write(*,*)
  write(*,*)'***************************************'
  write(*,*)'* Restricted 1h-static-GW Calculation *'
  write(*,*)'***************************************'
  write(*,*)
