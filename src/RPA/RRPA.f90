...
!------------------------------------------------------------------------
  ...
  if(dophRPA) then
    ...
    if (use_gpu) then
      ...
      if(CVS) then
        call MOM_phRRPA(dotest,TDA,doACFDT,exchange_kernel,singlet,triplet,nBas,nC,nO,nV,nR,nS,nCVS,FC,occupations,ENuc,ERHF,ERI,dipole_int,eHF)
      else
...
!------------------------------------------------------------------------
  ...
  if(dophRPAx) then
    ...
    call wall_time(start_RPA)
    if(CVS) then
      call MOM_phRRPAx(dotest,TDA,doACFDT,exchange_kernel,singlet,triplet,nBas,nC,nO,nV,nR,nS,nCVS,FC,occupations,ENuc,ERHF,ERI,dipole_int,eHF)
    else
